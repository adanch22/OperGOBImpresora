...
public class ConectivitySinEstatus extends ConnectionScreen {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       //setContentView(R.layout.activity_conectivity_sin_estatus);
        testButton.setText("?");

        Button printAsManyJobsButton = new Button(this);
        printAsManyJobsButton.setText("Imprimir Prueba Ticket");
        ...
        printAsManyJobsButton.setOnClickListener(new View.OnClickListener() {
    ...
    private void saveSettings() {
        SettingsHelper.saveBluetoothAddress(ConectivitySinEstatus.this, getMacAddressFieldText());
        SettingsHelper.saveIp(ConectivitySinEstatus.this, getTcpAddress());
        SettingsHelper.savePort(ConectivitySinEstatus.this, getTcpPortNumber());
    }
